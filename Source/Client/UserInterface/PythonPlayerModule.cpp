...
//WJ_ENABLE_TRADABLE_ICON
	...
	PyModule_AddIntConstant(poModule, "ON_TOP_WND_ACCE_COMBINE", ON_TOP_WND_ACCE_COMBINE);
	PyModule_AddIntConstant(poModule, "ON_TOP_WND_ACCE_ABSORB", ON_TOP_WND_ACCE_ABSORB);
#endif
