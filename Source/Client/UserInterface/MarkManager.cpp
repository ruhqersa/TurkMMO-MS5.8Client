...
bool CGuildMarkManager::SaveMarkIndex()
{
	...
	// Realizar el registro y guardar el valor de retorno
	int logResult = sys_log(0, "MarkManager::SaveMarkData: index count %d", m_mapGID_MarkID.size());
	
	// Ignorar explícitamente el valor de retorno para evitar la advertencia
	(void)logResult;
