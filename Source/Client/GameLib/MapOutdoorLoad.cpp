...
bool CMapOutdoor::LoadSetting(const char * c_szFileName)
{
	...
	D3DXMatrixScaling(&m_matStaticShadow,
		+m_fTerrainTexCoordBase * (static_cast<float>(CTerrainImpl::PATCH_XSIZE) / static_cast<float>(CTerrainImpl::XSIZE)),
		-m_fTerrainTexCoordBase * (static_cast<float>(CTerrainImpl::PATCH_YSIZE) / static_cast<float>(CTerrainImpl::XSIZE)),
		0.0f);
