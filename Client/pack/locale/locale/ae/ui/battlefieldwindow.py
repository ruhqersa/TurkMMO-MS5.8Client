			...
			(
					...
					(
						{
							...
							"children" :
							(
								{ "name":"column_rank", "type":"text", "x":466-194, "y":74-69, "text":uiScriptLocale.BATTLE_FILED_RANK, "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
								{ "name":"column_name", "type":"text", "x":374-194, "y":74-69, "text":uiScriptLocale.BATTLE_FILED_RANK_NAME, "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
								{ "name":"column_empire", "type":"text", "x":288-194, "y":74-69, "text":uiScriptLocale.BATTLE_FILED_RANK_EMPIRE, "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
								{ "name":"column_point", "type":"text", "x":237-194, "y":74-69, "text":uiScriptLocale.BATTLE_FILED_RANK_POINT, "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
							),
						},
					),
				},
				...
				## Battle info
				{
					...
					(
						...
						{ "name":"notice", "type":"text", "x":191, "y":18, "text": uiScriptLocale.BATTLE_FIELD_OPERATION_TIME_ALL, "text_vertical_align":"center" },
						{
							"name" : "enter_button",
							"type" : "button",
