...
def __InitData():
	...
	if app.ENABLE_GROWTH_PET_SYSTEM:
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_GYEONGGONG_BOOM, "", "d:/ymir work/effect/hit/gyeonggong_boom.mse")
...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_CHEONGEUN, "", "d:/ymir work/pc/warrior/effect/gyeokgongjang_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_GYEONGGONG, "", "d:/ymir work/pc/assassin/effect/gyeonggong_loop.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_GONGPO, "", "d:/ymir work/pc/sura/effect/fear_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_JUMAGAP, "", "d:/ymir work/pc/sura/effect/jumagap_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_HOSIN, "", "d:/ymir work/pc/shaman/effect/3hosin_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_BOHO, "", "d:/ymir work/pc/shaman/effect/boho_loop.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_KWAESOK, "", "d:/ymir work/pc/shaman/effect/10kwaesok_loop.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_FALLEN_CHEONGEUN, "", "d:/ymir work/pc/warrior/effect/gyeokgongjang_loop.mse")
	## 34 Polymoph
	...
	if app.ENABLE_WOLFMAN_CHARACTER:
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_BLEEDING, "Bip01", "d:/ymir work/effect/hit/blow_poison/bleeding_loop.mse")
